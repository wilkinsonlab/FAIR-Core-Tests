...
class FAIRTest
  def self.test_FM_I1_M_FormalLangSyntax_meta
    {
      ...
      metric: 'https://w3id.org/fair-metrics/general/FM_I1_M_FormalLangSyntax',
  ...
  def self.test_FM_I1_M_FormalLangSyntax_api
    api = OpenAPI.new(meta: test_FM_I1_M_FormalLangSyntax_meta)
    api.get_api
  end

  def self.test_FM_I1_M_FormalLangSyntax_about
    dcat = ChampionDCAT::DCAT_Record.new(meta: test_FM_I1_M_FormalLangSyntax_meta)
    dcat.get_dcat
  end
end
