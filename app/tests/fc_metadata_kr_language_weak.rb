class FAIRTest
  ...
  def self.fc_metadata_kr_language_weak_api
    api = FtrRuby::OpenAPI.new(meta: fc_metadata_kr_language_weak_meta)
    api.get_api
  end

  def self.fc_metadata_kr_language_weak_about
    dcat = FtrRuby::DCAT_Record.new(meta: fc_metadata_kr_language_weak_meta)
    dcat.get_dcat
  end
end
