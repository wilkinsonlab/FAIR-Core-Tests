class FAIRTest
  def self.fc_grounded_metadata_meta
    {
      ...
      metric: 'https://doi.org/10.25504/FAIRsharing.lXAOu2',
  ...
  def self.fc_grounded_metadata_api
    api = FtrRuby::OpenAPI.new(meta: fc_grounded_metadata_meta)
    api.get_api
  end

  def self.fc_grounded_metadata_about
    dcat = FtrRuby::DCAT_Record.new(meta: fc_grounded_metadata_meta)
    dcat.get_dcat
  end
end
