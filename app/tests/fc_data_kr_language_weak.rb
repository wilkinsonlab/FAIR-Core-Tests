...
class FAIRTest
  ...
  def self.fc_data_kr_language_weak(guid:)
    ...
    output = FAIRChampion::Output.new(
      testedGUID: guid,
      testid: fc_data_kr_language_weak_meta[:testid], 
      name: self.fc_data_kr_language_weak_meta[:testname], 
      version: self.fc_data_kr_language_weak_meta[:testversion],
      description: self.fc_data_kr_language_weak_meta[:description], 
      metric:self.fc_data_kr_language_weak_meta[:metric]
    )
...
#############################################################################################################
  ...
  def self.fc_data_kr_language_weak_api
    schemas = { 'subject' => ['string', 'the GUID being tested'] }

    api = OpenAPI.new(      title: self.fc_data_kr_language_weak_meta[:testname],
                            description: self.fc_data_kr_language_weak_meta[:description],
                            tests_metric: self.fc_data_kr_language_weak_meta[:metric],
                            version: self.fc_data_kr_language_weak_meta[:testversion],
                            applies_to_principle: self.fc_data_kr_language_weak_meta[:principle],
                            ...
                            path: self.fc_data_kr_language_weak_meta[:testid],
