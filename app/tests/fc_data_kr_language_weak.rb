...
#############################################################################################################
  ...
  def self.fc_data_kr_language_weak_api
    api = OpenAPI.new(meta: fc_data_kr_language_weak_meta)
    api.get_api
  end

  def self.fc_data_kr_language_weak_about
    dcat = ChampionDCAT::DCAT_Record.new(meta: fc_data_kr_language_weak_meta)
    dcat.get_dcat
  end
end
